...
import deeprl
from deeprl.common.type_aliases import TensorDict
from deeprl.common.utils import get_device, get_system_info
...
def save_to_zip_file(
    ...
    with zipfile.ZipFile(file, mode="w") as archive:
        ...
        archive.writestr("_deeprl", deeprl.__version__)
        ...
        with zipfile.ZipFile(file) as archive:
            ...
            if print_system_info:
                if "system_info.txt" in namelist:
                    ...
                    warnings.warn(
                        "The model was saved with DRL <= 0.1.0 and thus cannot print system information.",
                        UserWarning,
                    )
