...
from deeprl.common import utils
from deeprl.common.callbacks import BaseCallback, CallbackList, ConvertCallback, ProgressBarCallback
from deeprl.common.env_util import is_wrapped
...
from deeprl.common.vec_env import (
    DummyVecEnv,
    VecEnv,
    VecNormalize,
    VecTransposeImage,
...
class BaseAgent(ABC):
    """"
    The base class for all reinforcement learning agents.
    
    :param policy: The policy used by the agent.
    :param env: The invironment to learn from
        (if registered in Gym, can be str. Can be None for loading trained models)
    :param learning_rate: Learning rate for optimizer,
        it can be function of the current prgress remaining (from 1 to 0)
    :param policy_kwargs: Additional arguments to be passed to the policy on creation.
    :param stats_window_size: Windows size for the rollout logging, specifying the number of episodes to average
    ...
    def __init__(
        ...
        # Wheter the user passed a custom logger or not
