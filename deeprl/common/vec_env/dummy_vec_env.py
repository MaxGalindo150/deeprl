...
from deeprl.common.vec_env.base_vec_env import VecEnv, VecEnvIndices, VecEnvObs, VecEnvStepReturn
from deeprl.common.vec_env.patch_gym import _patch_env
from deeprl.common.vec_env.util import dict_to_obs, obs_space_info
...
class DummyVecEnv(VecEnv):
    ...
    def env_is_wrapped(self, wrapper_class: Type[gym.Wrapper], indices: VecEnvIndices = None) -> List[bool]:
        ...
        from deeprl.common import env_util
