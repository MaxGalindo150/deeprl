...
from deeprl.common.vec_env import DummyVecEnv, VecEnv, sync_envs_normalization

if TYPE_CHECKING:
    from deeprl.common import base_agent
...
class BaseCallback(ABC):
    ...
    # Type hint as string to avoid circular import
    def init_callback(self, model: "base_agent.BaseAgent") -> None:
        """
