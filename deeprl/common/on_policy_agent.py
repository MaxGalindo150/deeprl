...
from deeprl.common.buffers import DictRolloutBuffer, RolloutBuffer
...
from deeprl.common.utils import obs_as_tensor, safe_mean
from deeprl.common.vec_env import VecEnv

SelfOnPolicyAgent = TypeVar("SelfOnPolicyAgent", bound="OnPolicyAgent")
