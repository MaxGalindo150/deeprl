...
from deeprl.common.buffers import ReplayBuffer
...
class DQN(OffPolicyAgent):
    ...
    :param train_freq: Update the model every ``train_freq`` steps. Alternatively pass a tuple of frequency 
        and unit like ``(5, "step")`` or ``(2, "episode")``.
