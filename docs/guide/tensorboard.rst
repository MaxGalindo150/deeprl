...
To use Tensorboard with DeepRL, you simply need to pass the location of the log folder to the RL agent:
...
.. code-block:: python
    ...
    from deeprl import SAC
    from deeprl.common.callbacks import BaseCallback
    from deeprl.common.logger import Image
...
.. code-block:: python
    ...
    from deeprl import SAC
    from deeprl.common.callbacks import BaseCallback
    from deeprl.common.logger import Figure
...
.. code-block:: python
    ...
    from deeprl.common.logger import Video
...
.. code-block:: python
    ...
    from deeprl import A2C
    from deeprl.common.callbacks import BaseCallback
    from deeprl.common.logger import HParam
...
.. code-block:: python
    ...
    from deeprl import SAC
    from deeprl.common.callbacks import BaseCallback
    from deeprl.common.logger import TensorBoardOutputFormat
