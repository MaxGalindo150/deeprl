...
.. code-block:: python
    ...
    class CustomCallback(BaseCallback):
        ...
        def __init__(self, verbose: int = 0):
            ...
            # self.logger # type: deeprl.common.logger.Logger
...
Compared to Keras, DeepRL provides a second type of ``BaseCallback``, named ``EventCallback`` that is meant to trigger events. When an event is triggered, then a child callback is called.
...
DeepRL provides you with a set of common callbacks for:
...
.. code-block:: python
  ...
  from deeprl.common.callbacks import CheckpointCallback
...
.. note::
	...
	``ProgressBarCallback`` callback requires ``tqdm`` and ``rich`` packages to be installed. This is done automatically when using ``pip install deeprl[extra]``


.. code-block:: python

    from deeprl import PPO
    from deeprl.common.callbacks import ProgressBarCallback
...
.. code-block:: python
    ...
    from deeprl import SAC
    from deeprl.common.callbacks import CallbackList, CheckpointCallback, EvalCallback
...
.. code-block:: python
    ...
    from deeprl import SAC
    from deeprl.common.callbacks import EvalCallback, StopTrainingOnRewardThreshold
...
.. code-block:: python
  ...
  from deeprl import PPO
  from deeprl.common.callbacks import CheckpointCallback, EveryNTimesteps
...
.. code-block:: python
    ...
    from deeprl.common.callbacks import StopTrainingOnMaxEpisodes
...
.. code-block:: python
    ...
    from deeprl import SAC
    from deeprl.common.callbacks import EvalCallback, StopTrainingOnNoModelImprovement
...
.. automodule:: deeprl.common.callbacks
  :members: